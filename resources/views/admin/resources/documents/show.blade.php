                ...
                <div class="col-sm-10">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div>
                                <a class="btn btn-sm btn-info" href="{{ route('admin.manage-documents') }}">
                                    Back
                                </a>
                            </div>
                        </div>
                                        ...
                                        <table class="table border mb-0">
                                            ...
                                            @forelse($document->getMedia('documents') as $media)
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-end">
                                                        <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.document.media.download', ['media' => $media->id]) }}">
                                                            Download
                                                        </a>
                                                        @if (auth('web_admins')->user()->hasRole('administrator'))
                                                            <a class="btn btn-sm btn-danger text-white" href="{{ route('admin.document.media.destroy', ['media' => $media->id]) }}">
                                                                Delete
                                                            </a>
                                                        @endif
                                                    </td>
